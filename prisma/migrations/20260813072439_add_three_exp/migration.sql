...
INSERT INTO "new_TrashBin" ("binType", "createdAt", "description", "exp", "id", "imageUrl", "lat", "level", "lng", "name", "osmId", "source", "status", "updatedAt", "useCount") SELECT "binType", "createdAt", "description", "exp", "id", "imageUrl", "lat", "level", "lng", "name", "osmId", "source", "status", "updatedAt", "useCount" FROM "TrashBin";
DROP TABLE "TrashBin";
